...
const NFTDetails = () => {
  ...
  const url = "http://localhost:8010/proxy/api/nft/filtered_nfts"; // receive collection name from useLocation/navigation and add to url using template literal for NFTs only not collections
  ...
  return (
    <AnimatedPage>
      <div className="w-full h-screen bg-[white] font-inter">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div>
                <p className="text-4xl md:text-6xl font-extrabold tracking-widest">
                  {location.state.data.first_nft.name}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1400px] pt-6 md:pt-12 md:px-4  bg-[white] mx-auto">
          <div className="flex flex-col px-4 md:px-12 lg:grid grid-cols-2 max-w-[1400px] justify-between items-center">
            <div className="flex justify-center items-center ">
              <div className="rounded-xl ">
                <img
                  className="rounded-xl hover:shadow-xl duration-300"
            ...
            <div className="pt-4 md:pt-0 md:px-0 lg:px-6 flex items-center justify-center">
              <div className="flex flex-col gap-4">
                ...
                <p className="flex items-center gap-4">
                  {location.state.data.first_nft.quoteCurrency}{" "}
                  {location.state.data.first_nft.status === "approved" ? (
                    <FcCheckmark size={20} />
                  ) : (
                    <FcCancel />
                  )}
                </p>
                <p className="font-normal md:text-normal">
                  {location.state.desc
                    ? location.state.desc
                ...
                <p>
                  ...
                  {JSON.stringify(
                    location.state.data.first_nft.attributes,
                    null,
                    4
                  )}
                </p>
